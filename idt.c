...
*/
	...
	idt[0].baseExt=((long)(&int_handler_generic_0))>>0x020;
	idt[0].pad=0;
	...
	idt[1].baseExt=((long)(&int_handler_generic_1))>>0x020;
	idt[1].pad=0;
	...
	idt[2].baseExt=((long)(&int_handler_generic_2))>>0x020;
	idt[2].pad=0;
	...
	idt[3].baseExt=((long)(&int_handler_generic_3))>>0x020;
	idt[3].pad=0;
	...
	idt[4].baseExt=((long)(&int_handler_generic_4))>>0x020;
	idt[4].pad=0;
	...
	idt[5].baseExt=((long)(&int_handler_generic_5))>>0x020;
	idt[5].pad=0;
	...
	idt[6].baseExt=((long)(&int_handler_generic_6))>>0x020;
	idt[6].pad=0;
	...
	idt[7].baseExt=((long)(&int_handler_generic_7))>>0x020;
	idt[7].pad=0;
	...
	idt[8].baseExt=((long)(&int_handler_generic_8))>>0x020;
	idt[8].pad=0;
	...
	idt[9].baseExt=((long)(&int_handler_generic_9))>>0x020;
	idt[9].pad=0;
	...
	idt[10].baseExt=((long)(&int_handler_generic_10))>>0x020;
	idt[10].pad=0;
	...
	idt[11].baseExt=((long)(&int_handler_generic_11))>>0x020;
	idt[11].pad=0;
	...
	idt[12].baseExt=((long)(&int_handler_generic_12))>>0x020;
	idt[12].pad=0;
	...
	idt[13].baseExt=((long)(&int_handler_generic_13))>>0x020;
	idt[13].pad=0;
	...
	idt[14].baseExt=((long)(&int_handler_generic_14))>>0x020;
	idt[14].pad=0;

	idt[15].baseLow=((int)(&int_handler_generic_14)) & 0xFFFF;
	idt[15].selector=0x8;
	idt[15].flags=0x08e00;
	idt[15].baseHi=((int)(&int_handler_generic_15))>>0x010;
	idt[15].baseExt=((long)(&int_handler_generic_15))>>0x020;
	idt[15].pad=0;
	...
	idt[16].baseExt=((long)(&int_handler_generic_16))>>0x020;
	idt[16].pad=0;
	...
	idt[17].baseExt=((long)(&int_handler_generic_17))>>0x020;
	idt[17].pad=0;
	...
	idt[18].baseExt=((long)(&int_handler_generic_18))>>0x020;
	idt[18].pad=0;
	...
	idt[19].baseExt=((long)(&int_handler_generic_19))>>0x020;
	idt[19].pad=0;
	...
	idt[20].baseExt=((long)(&int_handler_generic_20))>>0x020;
	idt[20].pad=0;
	...
	idt[21].baseExt=((long)(&int_handler_generic_21))>>0x020;
	idt[21].pad=0;
	...
	idt[22].baseExt=((long)(&int_handler_generic_22))>>0x020;
	idt[22].pad=0;
	...
	idt[23].baseExt=((long)(&int_handler_generic_23))>>0x020;
	idt[23].pad=0;
	...
	idt[24].baseExt=((long)(&int_handler_generic_24))>>0x020;
	idt[24].pad=0;
	...
	idt[25].baseExt=((long)(&int_handler_generic_25))>>0x020;
	idt[25].pad=0;
	...
	idt[26].baseExt=((long)(&int_handler_generic_26))>>0x020;
	idt[26].pad=0;
	...
	idt[27].baseExt=((long)(&int_handler_generic_27))>>0x020;
	idt[27].pad=0;
	...
	idt[28].baseExt=((long)(&int_handler_generic_28))>>0x020;
	idt[28].pad=0;
	...
	idt[29].baseExt=((long)(&int_handler_generic_29))>>0x020;
	idt[29].pad=0;
	...
	idt[30].baseExt=((long)(&int_handler_generic_30))>>0x020;
	idt[30].pad=0;
	...
	idt[31].baseExt=((long)(&int_handler_generic_31))>>0x020;
	idt[31].pad=0;
	...
	idt[32].baseExt=((long)(&int_handler_generic_32))>>0x020;
	idt[32].pad=0;
	...
	idt[33].baseExt=((long)(&int_handler_generic_33))>>0x020;
	idt[33].pad=0;
	...
	idt[34].baseExt=((long)(&int_handler_generic_34))>>0x020;
	idt[34].pad=0;
	...
	idt[35].baseExt=((long)(&int_handler_generic_35))>>0x020;
	idt[35].pad=0;
	...
	idt[36].baseExt=((long)(&int_handler_generic_36))>>0x020;
	idt[36].pad=0;
	...
	idt[37].baseExt=((long)(&int_handler_generic_37))>>0x020;
	idt[37].pad=0;
	...
	idt[38].baseExt=((long)(&int_handler_generic_38))>>0x020;
	idt[38].pad=0;
	...
	idt[39].baseExt=((long)(&int_handler_generic_39))>>0x020;
	idt[39].pad=0;
	...
	idt[40].baseExt=((long)(&int_handler_generic_40))>>0x020;
	idt[40].pad=0;
	...
	idt[41].baseExt=((long)(&int_handler_generic_41))>>0x020;
	idt[41].pad=0;
	...
	idt[42].baseExt=((long)(&int_handler_generic_42))>>0x020;
	idt[42].pad=0;
	...
	idt[43].baseExt=((long)(&int_handler_generic_43))>>0x020;
	idt[43].pad=0;
	...
	idt[44].baseExt=((long)(&int_handler_generic_44))>>0x020;
	idt[44].pad=0;
	...
	idt[45].baseExt=((long)(&int_handler_generic_45))>>0x020;
	idt[45].pad=0;
	...
	idt[46].baseExt=((long)(&int_handler_generic_46))>>0x020;
	idt[46].pad=0;
	...
	idt[47].baseExt=((long)(&int_handler_generic_47))>>0x020;
	idt[47].pad=0;
	...
	idt[48].baseExt=((long)(&int_handler_generic_48))>>0x020;
	idt[48].pad=0;
	...
	idt[49].baseExt=((long)(&int_handler_generic_49))>>0x020;
	idt[49].pad=0;
	...
	idt[50].baseExt=((long)(&int_handler_generic_50))>>0x020;
	idt[50].pad=0;
	
	idt_ptr.idt_size=64*256;
    idt_ptr.idt_address=(long)idt;
