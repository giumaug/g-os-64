		       ...
		       struct t_process_context* new_process_context)
{
	*(system.process_info->tss.esp)=KERNEL_STACK;
	...
	current_process_context->processor_reg.rcx=processor_reg->rcx;
	current_process_context->processor_reg.rdx=processor_reg->rdx;
	current_process_context->processor_reg.rsi=processor_reg->rsi;
	current_process_context->processor_reg.rdi=processor_reg->rdi;
	current_process_context->processor_reg.rsp=processor_reg->rsp;
	current_process_context->processor_reg.r8=processor_reg->r8;
	current_process_context->processor_reg.r9=processor_reg->r9;
	current_process_context->processor_reg.r10=processor_reg->r10;
	current_process_context->processor_reg.r11=processor_reg->r11;
	current_process_context->processor_reg.r12=processor_reg->r12;
	current_process_context->processor_reg.r13=processor_reg->r13;
	current_process_context->processor_reg.r14=processor_reg->r14;
	current_process_context->processor_reg.r15=processor_reg->r15;

	//restore new process state
	processor_reg->rax=new_process_context->processor_reg.rax;
	processor_reg->rbx=new_process_context->processor_reg.rbx;
	processor_reg->rcx=new_process_context->processor_reg.rcx;
	processor_reg->rdx=new_process_context->processor_reg.rdx;
	processor_reg->rsi=new_process_context->processor_reg.rsi;
	processor_reg->rdi=new_process_context->processor_reg.rdi;
	processor_reg->rsp=new_process_context->processor_reg.rsp;
	processor_reg->r8=new_process_context->processor_reg.r8;
	processor_reg->r9=new_process_context->processor_reg.r9;
	processor_reg->r10=new_process_context->processor_reg.r10;
	processor_reg->r11=new_process_context->processor_reg.r11;
	processor_reg->r12=new_process_context->processor_reg.r12;
	processor_reg->r13=new_process_context->processor_reg.r13;
	processor_reg->r14=new_process_context->processor_reg.r14;
	processor_reg->r15=new_process_context->processor_reg.r15;
}
...
void schedule(struct t_process_context *current_process_context,struct t_processor_reg *processor_reg)
{
	...
	struct t_process_context* process_0;
	t_llist_node* node;
	t_llist_node* next;
...
u32 _exec(char* path,char* argv[]) 
{
	...
	current_process_context->file_desc = dc_hashtable_init(PROCESS_INIT_FILE, (void (*)(void*)) &file_free);
	current_process_context->socket_desc = dc_hashtable_init(PROCESS_INIT_SOCKET, (void (*)(void*)) &socket_free);
	...
	stack_data = (char*) (stack_data_pointers+argc);
