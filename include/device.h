...
{
	u8 (*read)(t_io_request* io_request);
	u8 (*write)(t_io_request* io_request);
	u8 (*p_read)(t_io_request* io_request);
	u8 (*p_write)(t_io_request* io_request);
	u8 (*read_dma)(t_io_request* io_request);
	u8 (*write_dma)(t_io_request* io_request);
	void* dev;
	unsigned int status;
