...
#define VIRT_MEM_START_ADDR 0x400000000
#define VIRT_MEM_END_ADDR 0x400000000+PHY_MEM_SIZE
...
#define PROC_VIRT_MEM_START_ADDR 0x100000    	//1M - 8G
#define HEAP_VIRT_MEM_START_ADDR 0x200000000  	//8G - 16G
#define HEAP_INIT_SIZE 0x200000
#define KERNEL_STACK 0x3FFCFF000        			//16G - 3M - 4k hole; size = 0x2000
#define KERNEL_STACK_SIZE 0x2000          
#define USER_STACK 0x3FFCFC000                	//16G - 3M - 4K hole - 8K - 4K hole;size 0x40000000
#define USER_STACK_INIT_SIZE 0x40000000

#define MASTER_PML4 0xE00000
#define MASTER_PTR 0xE01000
#define MASTER_DIR  0xE02000 
#define MASTER_PAGES 0xE13000
