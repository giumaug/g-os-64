...
//System with 4G
//Nota in x86QSP1 doesn't AHCI controller doesn't manage 64bit. G-OS can work with 4G only currently.
...
#define BUDDY_START_ADDR ALIGNED_TO_OFFSET((MEM_START_ADDR + (ALLOCATED_MEM / 10)), PAGE_SIZE)
