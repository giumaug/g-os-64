...
//System with 4G
//Note: In x86QSP1 AHCI controller doesn't manage 64bit. AHCI doens't use kmalloc but static memory only.
#define PHY_MEM_SIZE 0x200000000ULL
#define G_PHY_MEM_SIZE (PHY_MEM_SIZE / 0x40000000ULL)
#define PHY_MASTER_PML4 0x400000ULL
#define PHY_MASTER_PTR 0x401000ULL
#define PHY_MASTER_DIR  0x402000ULL
...
#define PHY_MASTER_PAGES (0x403000ULL + (0x1000ULL * (G_PHY_MEM_SIZE + 1)))
#define STATIC_BUDDY_STRUCT_START_ADDR (PHY_MASTER_PAGES + (0x200000ULL * (G_PHY_MEM_SIZE + 1)))
